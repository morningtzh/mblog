{
    "SSE": {
        "BASEINFO": [ "公司法定中文名称", "公司法定代表人", "公司注册地址", "公司办公地址邮政编码",
        ...
        "STOKESTRUCTURE": [ "国家持有的有限售条件流通股份数", "国有法人持有的有限售条件流通股份数", "其他有限售条件的内资流通股份数",
        ...
        "BALANCESHEET": [ "货币资金(元)", "结算备付金(元)", "拆出资金(元)", "交易性金融资产(元)", "应收票据(元)", "应收帐款(元)",
        ...
        "INCOMESTATEMENT": [ "营业总收入(元)", "营业收入(元)", "金融资产利息收入(元)", "已赚保费(元)", "手续费及佣金收入(元)", "营业总成本(元)",
        ...
        "CASHFLOWSTATEMENT": [ "销售商品提供劳务收到的现金(元)", "客户存款和同业存放款项净增加额(元)", "向中央银行借款净增加额(元)",
